defmodule BookSearchWeb.BookControllerTest do
  ...
  @create_attrs %{description: "some description", author: "some author", title: "some title", embedding: "some embedding"}
  @update_attrs %{description: "some updated description", author: "some updated author", title: "some updated title", embedding: "some updated embedding"}
  @invalid_attrs %{description: nil, author: nil, title: nil, embedding: nil}
